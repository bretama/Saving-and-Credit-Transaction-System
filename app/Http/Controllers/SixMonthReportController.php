...
class SixMonthReportController extends Controller
{
  ...
  //               ->where('deleted_at', NULL);
       ...
       $entrydate = explode("/", $timestamp);
        ...
        $abalatcount = Abalat::where('deleted_at',NULL)->where('entrydates','>=',$entrydate1)->orWhere('entrydates','==',NULL)->count();
        $aa = Abalat::count();
        // dd($aa);
