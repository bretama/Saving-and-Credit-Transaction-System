              ...
              <div class="col-md-6">
               ...
               <div class="form-group">
                ...
                <br>
                <div class="form-group">
                  <label class="control-label col-md-3" for="">ዝወፀሉ ዕለት:<span class="text-danger">*</span></label>
                   <div class="col-md-6">
                  <input id="leavedate" name="leavedate" type="date" placeholder="" class="form-control" value=""></div>
                </div>