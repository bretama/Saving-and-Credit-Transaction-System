...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">additionalexpences</h1>

          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"> <a href="{{url('/additionalexpensedisplay')}}">additionalexpences</a> </li>
              <li class="breadcrumb-item active">additionalexpences</li>
            </ol>
          </div>
        </div>
      </div>
...
<section class="content">
    ...
    @endif
        <form method="post" action="/additionalexpenseregister1">
                <div class="col-md-5">
        <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">additionalexpences register</h3>
        </div>
        @foreach($errors->all() as $error)
          <li>{{$error}}</li>
        @endforeach
