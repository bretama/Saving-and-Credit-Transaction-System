...
<section class="content">
    ...
    @endif
        <form method="post" action="/abelregister1">
                <div class="col-md-5">
        <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Abels register</h3>
        </div>
        @foreach($errors->all() as $error)
          <li>{{$error}}</li>
        @endforeach
        <div class="box-body">
             ...
             <div class="form-group">
              ...
              <div class="col-md-6">
                <input id="numdays" name="numdays" type="text" placeholder="" class="form-control"></div>
              </div>
              <br>
              <br>
                <div class="form-group">
              ...
              <div class="col-md-6">
                <input id="perday" name="perday" type="text" placeholder="" class="form-control"></div>
              </div>
              <br>
              <br>
               <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="col-md-6">
                <input id="forbed" name="forbed" type="text" placeholder="" class="form-control"></div>
              </div>
              <br>
              <br>
               <div class="form-group">
              ...
              <div class="col-md-6">
                <input id="taxi" name="taxi" type="text" placeholder="" class="form-control"></div>
              </div>
              <br>
              <br>
              ...
              <div class="col-md-6">
                <input id="receipt" name="receipt" type="text" placeholder="" class="form-control"></div>
              </div>
              <br>
              <br>
