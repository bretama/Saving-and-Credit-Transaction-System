...
<!-- Content Header (Page header) -->
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
         ...
         <div class="table-responsive">
             ...
             <h4>total members entered this time=={{$abalatsumpermonth}}</h4>
             <h4>total registration fee in this time=={{$feesum}}</h4>
             <h4>female members entered this time=={{$abalatfemale}}</h4>
             <h4>male intered in this time=={{$abalatmale}}</h4>
             <h4> children in this time=={{$child}}</h4>
        </div>
           ...
           <h4>total amount in this month={{$monthlyamount}}</h4>
                ...
                <h4>total share in this month={{$monthlyshare}}</h4>
                  <h4>total administration fee in this month={{$monthlyadmi}}</h4>
                  <h4>total interest in this month={{$monthlyinterest}}</h4>
 ...
 <h2>Admin fee not payed</h2>
         <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="table11">
                     ...
                     @foreach($monthlysem1 as $monthly)
                    <tr>
                        <td>{{$monthly->accountNum}}</td>
                        <td>{{$monthly->name}} {{$monthly->fname}}</td>
                        <td>{{$monthly->gender}}</td>
 ...
 <h2>Admin fee not payed in children</h2>
         <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="table11">
                     ...
                     @foreach($childrensem1 as $monthly)
                    <tr>
                        <td>{{$monthly->accountNum}}</td>
                        <td>{{$monthly->name}} {{$monthly->fname}}</td>
                        <td>{{$monthly->gender}}</td>
