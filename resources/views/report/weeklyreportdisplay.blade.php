...
<!-- Content Header (Page header) -->
    ...
    <div class="content-header">
    	<div class="container-fluid">
    		<div class="row mb-2">
    			<div class="col-sm-6">
    				<h1 class="m-0 text-dark"><b>weekly Report</b></h1>
    ...
    <div class="box box-primary">
        ...
        <div class="box-header with-border">
    		<h2>Monthly-Savings weekly report</h2>
            <div class="table-responsive">
    ...
    <div class="box-header with-border">
            <h2>FreeInterest Savings weekly report</h2>
            <div class="table-responsive">
            <table class="table table-bordered table-striped" id="table11">
                <tr>
    ...
    <div class="box-header with-border">
            <h2>Investment Savings weekly report</h2>
            <div class="table-responsive">
            <table class="table table-bordered table-striped" id="table11">
                <tr>
                    <th>Total Amount</th>
    ...
    <div class="box-header with-border">
            <h2>Voluntaryamount Savings weekly report</h2>
            <div class="table-responsive">
            <table class="table table-bordered table-striped" id="table11">
                <tr>
                    <th>Total Amount</th>
    ...
    <div class="box-header with-border">
            <h2>Timelimite Savings weekly report</h2>
            <div class="table-responsive">
            <table class="table table-bordered table-striped" id="table11">
                <tr>
                    <th>Total Amount</th>
    ...
    <div class="box-header with-border">
     ...
     <div class="box-header with-border">
            <h2>Total info. weekly report</h2>
            <div class="table-responsive">
            <table class="table table-bordered table-striped" id="table11">
                <tr>
                    <th>Total Members</th>
