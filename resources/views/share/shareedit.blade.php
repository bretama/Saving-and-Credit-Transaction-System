    		...
    		<div class="row mb-2">
    			...
    			<div class="col-sm-6">
    				<ol class="breadcrumb float-sm-right">
    					<li class="breadcrumb-item"> <a href="{{url('/shareregister')}}">see shares</a> </li>
...
<section class="content">
    <div class="container">
    		...
    		<form method="post" action="{{url('/shareupdate')}}/{{$edit->id}}">
          {{ csrf_field()}}
                <div class="col-md-5">
        ...
        <div class="box-body">
                  ...
                  <label class="control-label col-sm-3" for="month">Account Number:<span class="text-danger">*</span></label>
              <div class="col-md-6">
