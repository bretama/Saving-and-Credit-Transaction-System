...
<!-- Content Header (Page header) -->
    <div class="content-header">
    	<div class="container-fluid">
    		<div class="row mb-2">
    			<div class="col-sm-6">
    				<h1 class="m-0 text-dark">penality</h1>

    			</div>
    			<div class="col-sm-6">
    				<ol class="breadcrumb float-sm-right">
    					<li class="breadcrumb-item"> <a href="{{url('/penalitydisplay')}}">penality</a> </li>
...
<section class="content">
    <div class="container">
    		...
    		<form method="post" action="{{url('/penalityupdate')}}/{{$edit->id}}">
                <div class="col-md-5">
        <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Edit penality</h3>
        </div>
        ...
        <div class="box-body">
             ...
             <div class="form-group">
              ...
              <div class="col-md-6">
                <input id="penality" name="penality" value="{{$edit->penality}}" type="text" placeholder="" class="form-control" required=""></div>
              </div>
              <br>
              <br>
                                <div class="form-group">
              ...
              <div class="col-md-6">
                    <select class="form-control chosen" name="type" value="{{$edit->type}}" id="type" required="required">
                      <option selected disabled>~choose~</option>
