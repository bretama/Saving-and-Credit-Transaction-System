...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">List of Voluntary Saving</h1>

          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"> <a href="{{url('/voluntarydisplay')}}">File of Voluntary Saved</a> </li>
              <li class="breadcrumb-item active">File of Voluntry Saving
             </li>
...
<section class="content">
    <div class="container">
        ...
        <form method="post" action="{{url('/voluntaryregister1')}}">
                <div class="col-md-5">
        <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Register Soluntary</h3>
        </div>
