...
<!-- Content Header (Page header) -->
    <div class="content-header">
    	<div class="container-fluid">
    		<div class="row mb-2">
    			<div class="col-sm-6">
    				<h1 class="m-0 text-dark">Children Savings</h1>

    			</div>
    			<div class="col-sm-6">
    				<ol class="breadcrumb float-sm-right">
    					<li class="breadcrumb-item"> <a href="{{url('/childrendisplay')}}">ልist of Children</a> </li>
...
<section class="content">
    ...
    @endif
    		<form method="post" action="{{url('/childrenregister1')}}">
                <div class="col-md-5">
