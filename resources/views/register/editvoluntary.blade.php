...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">voluntary saving</h1>

          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"> <a href="{{url('/voluntarydisplay')}}">voluntary savings</a> </li>
              <li class="breadcrumb-item active">edit voluntary saving </li>
            </ol>
          </div>
        </div>
      </div>
...
<section class="content">
    <div class="container">
        ...
        <form method="post" action="{{url('/voluntaryupdate')}}/{{$edit->id}}">
                <div class="col-md-5">
        ...
        <div class="box-body">
              ...
              <div class="col-md-6">
                    <select class="form-control chosen" name="code" id="code" value="{{$edit->code}}" required="required">
              ...
              <div class="col-md-6">
                <input id="sem1" name="sem1" type="text" value="{{$edit->sem1}}" placeholder="" class="form-control" value="" ></div>
              </div>
              <br>
              <br>
