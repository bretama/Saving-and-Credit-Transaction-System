    		...
    		<div class="row mb-1">
    			...
    			<div class="col-sm-4">
    				<ol class="breadcrumb float-sm-right">
    					<li class="breadcrumb-item"> <a href="{{url('/monthlydisplay')}}">Free-Interest Savings</a> </li>
...
<section class="content">
    <div class="container">
    		...
    		<form method="post" action="{{url('/freeinterestregister1')}}">
                <div class="col-md-11">
        <div class="box box-primary">
        <div class="box-header with-border">
          <h1 class="box-title">Register Free-Interest</h1>
        </div>
        ...
        <div class="box-body">
             ...
             <div class="form-group">
              ...
              <br>
              <div class="form-group">
              <label class="col-md-1 control-label" for="sem">For Director</label>
              <div class="col-md-3">
...
<div class="ln_solid"></div>
                            <div class="form-group">
                                <div class="col-md-4 col-sm-4 col-xs-11 col-md-offset-1">
