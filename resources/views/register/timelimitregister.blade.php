...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">List of time limited Saving</h1>

          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"> <a href="{{url('/timelimitdisplay')}}">File of Time Limited Saving</a> </li>
              <li class="breadcrumb-item active">Time Limited Saving</li>
            </ol>
          </div>
        </div>
      </div>
...
<section class="content">
    <div class="container">
        ...
        <form method="post" action="{{url('/timelimitregister1')}}">
                <div class="col-md-5">
        <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Time Limited Saving</h3>
        </div>
        ...
        <div class="box-body">
                  ...
                  <label class="control-label col-sm-3" for="">Code:<span class="text-danger">*</span></label>
              <div class="col-md-6">
              ...
              <br>
              <div class="form-group">
              <label class="col-md-3 control-label" for="">For Director</label>
              <div class="col-md-6">
              ...
              <br>
               ...
               <div class="form-group">
                <label class="col-md-3 control-label" for="dob">Leave Date</label>
                <div class="col-md-6">
