    		...
    		<div class="row mb-2">
    			...
    			<div class="col-sm-6">
    				<ol class="breadcrumb float-sm-right">
    					<li class="breadcrumb-item"> <a href="{{url('/withdrawaldisplay')}}">list of credits</a> </li>
...
<section class="content">
    <div class="container">
    		...
    		<form method="post" action="{{url('/withdrawalupdate')}}/{{$edit->id}}">
                <div class="col-md-5">
             ...
             <div class="form-group">
              ...
              <div class="col-md-6">
               ...
               <div class="form-group">
                ...
                <div class="col-md-6">
                  <input id="withdrawalDate" name="withdrawalDate" value="{{$edit->withdrawalDate}}" type="date" placeholder="" class="form-control" value="" required=""></div>
