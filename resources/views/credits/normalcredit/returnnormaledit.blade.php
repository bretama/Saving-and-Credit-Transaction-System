...
<section class="content">
    ...
    @endif
        <form method="post" action="{{url('/returnnormalupdate')}}/{{$edit->id}}">
                <div class="col-md-5">
        ...
        <div class="box-body">
              ...
              <br> -->
              <div class="form-group">
                  <label class="control-label col-sm-3" for="month">normal credit:<span class="text-danger">*</span></label>
              <div class="col-md-6">
             ...
             <div class="form-group">
              ...
              <div class="col-md-6">
                <input id="interest" name="interest" value="{{$edit->interest}}" type="text" placeholder="" class="form-control"></div>
              </div>
              <br>
              <br>
              <div class="form-group">
              ...
              <div class="col-md-6">
               ...
               <div class="form-group">
                ...
                <div class="col-md-6">
                  <input id="creditDate" name="creditDate" value="{{$edit->creditDate}}" type="date" placeholder="" class="form-control" value=""></div>
