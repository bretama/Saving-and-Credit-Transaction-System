...
<section class="content">
    <div class="container">
        ...
        <div class="box-body">
                  ...
                  <label class="control-label col-sm-3" for="month">code:<span class="text-danger">Code</span></label>
              <div class="col-md-6">
                    <select class="form-control" name="code" id="code" required="required">
                      <option selected disabled>~choose~</option>
                      @foreach($abalats as $abal)
                      <option >{{$abal->code}} </option>
                      @endforeach
        ...
        <div class="box-body">
             ...
             <div class="form-group">
              ...
              <div class="col-md-6">
                <input id="amount" name="amount" type="number" placeholder="" class="form-control" value="" required=""></div>
              </div>
              <br>
              <br>
